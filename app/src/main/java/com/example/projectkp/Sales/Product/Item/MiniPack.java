...
public class MiniPack extends AppCompatActivity implements com.example.projectkp.Sales.Product.Adapter.AdapterProductItem.OnItemClickListener {

    private final DatabaseReference Product = FirebaseDatabase.getInstance().getReference("Product");
    private com.example.projectkp.Sales.Product.Adapter.AdapterProductItem productAdapter;
    ...
    private void setUpRecyclerView() {
        ...
        Product.child("Mini_Pack").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                productAdapter.setOnItemClickListener(com.example.projectkp.Sales.Product.Item.MiniPack.this);
