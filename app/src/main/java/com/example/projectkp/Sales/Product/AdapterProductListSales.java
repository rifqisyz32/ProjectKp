...
import com.example.projectkp.Sales.UserDetailSales;
...
public class AdapterProductListSales extends RecyclerView.Adapter<AdapterProductListSales.productViewHolder> {
    ...
    public productViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.holder_product_list_sales, viewGroup, false);
    ...
    public void moveToProduct(int position) {
        switch (position) {
            ...
            case 2:
                mContext.startActivity(new Intent(mContext, ThreePSales.class));
                break;
            ...
            case 5:
                mContext.startActivity(new Intent(mContext, UserDetailSales.class));
                break;
    ...
    public class productViewHolder extends RecyclerView.ViewHolder {
        ...
        public productViewHolder(@NonNull View itemView) {
            super(itemView);
            listProductItem = itemView.findViewById(R.id.list_product_item_bg_sales);
            listProductImage = itemView.findViewById(R.id.list_product_item_img_sales);
            listProductText = itemView.findViewById(R.id.list_product_item_text_sales);
        }
    }
}
