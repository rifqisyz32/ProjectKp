...
public class AdapterOrbitSales extends FirebaseRecyclerAdapter<ProductHelper, AdapterOrbitSales.productViewHolder> {

    private OnItemClickListener listener;
    Context context;

    public AdapterOrbitSales(@NonNull FirebaseRecyclerOptions<ProductHelper> options) {
        super(options);
    }
    ...
    class productViewHolder extends RecyclerView.ViewHolder {
        ...
        public productViewHolder(View itemView) {
            ...
            price.setText("");
            device.setText(R.string.period_time);
