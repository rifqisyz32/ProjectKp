...
public class InternetTV extends AppCompatActivity implements com.example.projectkp.Sales.Product.Adapter.AdapterProductItem.OnItemClickListener {
    ...
    private void setUpRecyclerView() {
        ...
        Product.child("Internet_TV").addValueEventListener(new ValueEventListener() {
            @Override
