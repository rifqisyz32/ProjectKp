...
public class AdapterMinipackSales extends FirebaseRecyclerAdapter<ProductHelper, AdapterMinipackSales.productViewHolder> {

    private OnItemClickListener listener;
    Context context;

    public AdapterMinipackSales(@NonNull FirebaseRecyclerOptions<ProductHelper> options) {
        super(options);
    }
    ...
    class productViewHolder extends RecyclerView.ViewHolder {
        ...
        public productViewHolder(View itemView) {
            ...
            device.setText(R.string.channel);
