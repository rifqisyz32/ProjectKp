...
public class AdapterPCS extends FirebaseRecyclerAdapter<ProductHelper, AdapterPCS.productViewHolder> {

    private OnItemClickListener listener;
    Context context;

    public AdapterPCS(@NonNull FirebaseRecyclerOptions<ProductHelper> options) {
        super(options);
    }
