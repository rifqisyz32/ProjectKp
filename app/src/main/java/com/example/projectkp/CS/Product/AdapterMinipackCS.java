...
public class AdapterMinipackCS extends FirebaseRecyclerAdapter<ProductHelper, AdapterMinipackCS.productViewHolder> {

    private OnItemClickListener listener;
    Context context;

    public AdapterMinipackCS(@NonNull FirebaseRecyclerOptions<ProductHelper> options) {
        super(options);
    }
