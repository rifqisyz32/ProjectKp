...
public class InternetPhone extends AppCompatActivity implements com.example.projectkp.CS.Product.Adapter.AdapterProductItem.OnItemClickListener {
    ...
    private final String myKey = "Internet_Phone";
    private final String myTitle = "2P (Internet + Phone)";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bonusButton.setOnClickListener(v -> {
            Intent dataUser = new Intent(getApplicationContext(), com.example.projectkp.Sales.Product.Bonus.InternetPhone.class);
