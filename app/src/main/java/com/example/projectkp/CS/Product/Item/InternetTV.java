...
public class InternetTV extends AppCompatActivity implements com.example.projectkp.CS.Product.Adapter.AdapterProductItem.OnItemClickListener {
    ...
    private final String myKey = "Internet_TV";
    private final String myTitle = "2P (Internet + TV)";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bonusButton.setOnClickListener(v -> {
            Intent dataUser = new Intent(getApplicationContext(), com.example.projectkp.Sales.Product.Bonus.InternetTV.class);
    ...
    private void setUpRecyclerView() {
        ...
        Product.child(myKey).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                productAdapter.setOnItemClickListener(InternetTV.this);
