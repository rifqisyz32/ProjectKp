...
public class AdapterOrbitCS extends FirebaseRecyclerAdapter<ProductHelper, AdapterOrbitCS.productViewHolder> {

    private OnItemClickListener listener;
    Context context;

    public AdapterOrbitCS(@NonNull FirebaseRecyclerOptions<ProductHelper> options) {
        super(options);
    }
